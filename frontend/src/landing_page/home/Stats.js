    ...
    return ( 
        <div className="container p-3 ">
            <div className="row p-5">
                ...
                <div className="col-6 p-5">
                    <img src="media/images/ecosystem.png"alt="ecosystem_image" style={{width:"100%"}}/>
            ...
            <img src="media/images/pressLogos.png" alt="pressLogos_image" style={{width:"60%"}}  className='img-fluid'/>
            </div>
